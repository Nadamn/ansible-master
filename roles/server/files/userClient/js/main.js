...
function shelve(status, book_id) {
  ...
  xhttp.open("POST", `http://192.168.0.50:5000/books/${book_id}/shelve`);
...
function rating_request(book_id) {
  ...
  xhttp.open("POST", `http://192.168.0.50:5000/booksRouter/${book_id}/rate`);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send(JSON.stringify({
    user_id: localStorage.getItem("userId"),
...
function rate(div) {
  ...
  function rating_request(book_id) {
    ...
    xhttp.open("POST", `http://192.168.0.50:5000/books/${book_id}/rate`);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send(JSON.stringify({
      user_id: localStorage.getItem("userId"),
